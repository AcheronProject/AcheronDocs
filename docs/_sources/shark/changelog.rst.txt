...
-------------------
	...
	Changed the grid used from the standard 19.05mm to the 19mm used in the Planck </h6>

V3.0.5 (2019/01/21)
-------------------

	Solved a problem with connector wiring and added a nice render to the README </h6>
